...
class GaussianDiffusion(nn.Module):
    ...
    def p_sample(self, model, x_start, x_sec_hop, steps, sampling_noise=False):
    ...
    def training_losses(self, model, x_start, x_sec_hop, reweight=False):
