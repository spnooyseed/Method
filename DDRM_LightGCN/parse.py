...
def parse_args():
    ...
    parser.add_argument(
        "--recdim", type=int, default=300, help="the embedding size of lightGCN"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--dropout", type=float, default=0, help="using the dropout or not"
    )
    parser.add_argument(
        "--keepprob",
        type=float,
    ...
    parser.add_argument(
        "--testbatch", type=int, default=256, help="the batch size of users for testing"
    )
    parser.add_argument(
        "--data_path", type=str, default="../Datasets/", help="the path to dataset"
    )
    parser.add_argument(
        "--dataset",
        type=str,
    ...
    parser.add_argument("--data_type", type=str, default="time", help="time or random")
    parser.add_argument(
    ...
    parser.add_argument(
        "--dims", type=str, default="[200,600]", help="the dims for the DNN"
    )
    parser.add_argument(
        "--act", type=str, default="tanh", help="the activate function for the DNN"
    )
    parser.add_argument(
        "--w_dims", type=str, default="[200,600]", help="the dims for the W DNN"
    )
    parser.add_argument(
        "--emb_size", type=int, default=10, help="timestep embedding size"
    )
    parser.add_argument(
        "--norm", type=bool, default=False, help="Normalize the input or not"
    )
    parser.add_argument(
        "--diff_lr", type=float, default=0.001, help="the learning rate"
    )
    # diff params
    parser.add_argument(
    ...
    parser.add_argument(
        "--alpha", type=float, default=0.1, help="balance rec loss and reconstruct loss"
    )
    ...
    parser.add_argument("--beta", type=float, help="drop rate", default=0.2)
