                                    ...
                                    for max_ in max_list:
                                        ...
                                        for dims in dims_list:
                                            for i, scale in enumerate(scale_list):
                                                log = f"log_{log_num}"
                                                print(
                                                    f"run ==>  {dataset}_lr{lr}_difflr{dlr}_layer{layer}_alpha{alpha}_steps{steps}_sample{int(steps*sample)}_min{min_}_max{max_}_dims{dims}_scale{scale}_{log}"
                                                )
